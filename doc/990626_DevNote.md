...
ドイツのスタートアップ企業[Codasip](https://codasip.com/)の方が，RISC-V Summit Europe 2025で発表した
[ポスター](https://riscv-europe.org/summit/2025/media/proceedings/2025-05-13-RISC-V-Summit-Europe-P2.1.01-PRIKRYL-poster.pdf)と
[論文](https://riscv-europe.org/summit/2025/media/proceedings/2025-05-13-RISC-V-Summit-Europe-P2.1.01-PRIKRYL-abstract.pdf)
を発見しました．
RISC-V上でInfoNESを動かした上で，CPUをハードウェア化することで，性能が22%向上したという話です．
[Known source ports](https://github.com/jay-kumogata/InfoNES/tree/master#known-source-ports)の方には，追加しました．

昔のハードウェア/ソフトウェア協調設計のような内容です．
ハードウェア/ソフトウェア界面をどこに置くかは，永遠のテーマなのかもしれません．
生物でいうと，先天的か後天的かみたいな話です．
直接関係ないですが，生成AI向けの計算では，かなりハードウェア寄りな場所に界面があるのかもしれません．
